 ...
 */
val PARENT_VALIDATION_CHAIN = listOf(validate1SimpleX, validate2ThrowableX, validateParent3X)

val CHILD_VALIDATION_CHAIN = listOf(validateChild31X, validateChild32X)
